...
# The paper shows how predictive distributions of outstanding liabilities in general insurance can be obtained using 
# bootstrap or 'Bayesian' MCMC techniques for clearly defined statistical models.

# The code supports Mack's model, the Over-dispersed Poisson model,
...
# Bayesian and Bootstrap Summary
